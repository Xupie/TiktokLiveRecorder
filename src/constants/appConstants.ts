...
export const TIKTOK_CHECK_ALIVE_URL: (roomID: number) => string = (roomID) =>
    `https://webcast.tiktok.com/webcast/room/check_alive/?aid=1988&region=FI&room_ids=${roomID}&user_is_login=true`;
export const TIKTOK_ROOM_INFO_URL: (roomID: number) => string = (roomID) =>
    `https://webcast.tiktok.com/webcast/room/info/?aid=1988&region=FI&room_id=${roomID}`;
